...
namespace Kata.Spec
{
    ...
    public class when_input_is_one_number
    {
        ...
        It should_return_zero = () => { _result.Should().Be(3); };
        static Calculator _systemUnderTest;
        static int _result;
    }
    ...
    public class when_input_is_has_new_line_delimiter
    {
        Establish _context = () => { _systemUnderTest = new Calculator(); };
    ...
    public class when_input_is_has_custom_delimiter
    {
        Establish _context = () => { _systemUnderTest = new Calculator(); };
    ...
    public class when_input_is_has_a_negative_number
    {
        Establish _context = () => { _systemUnderTest = new Calculator(); };

        Because of = () => { _result = Catch.Exception(()=> _systemUnderTest.Add("1,-2,3")) ; };

        It should_return_the_sum_of_all_numbers = () => { _result.Message.Should().Be("negatives not allowed: -2"); };
        static Calculator _systemUnderTest;
